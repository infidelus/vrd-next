...
class MaintenancePage(SettingsPage):
    ...
    def build(self):
        ...
        cache_row.addWidget(QLabel("Delete cached data older than"))
        ...
        self.add(hint(
            "Edit every setting directly as text - including the keyboard "
        ...
        restore = QPushButton("Restore Default Settings")
        ...
        self.add(hint(
            "Reset every setting - paths, options and keyboard shortcuts - "
